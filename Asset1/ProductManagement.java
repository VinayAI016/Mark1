...
public class ProductManagement extends JFrame {
    ...
    private void addProduct() {
        ...
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("/home/vinxyyy/Desktop/New Projects/Asset1/products.txt", true));
    ...
    private void deleteProduct() {
        ...
        try {
            File inputFile = new File("/home/vinxyyy/Desktop/New Projects/Asset1/products.txt");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ProductManagement gui = new ProductManagement();
                gui.setVisible(true);
            }
        });
    }
